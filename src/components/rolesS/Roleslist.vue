    ...
    <el-card class="box-card">
      ...
      >
        ...
        <template v-slot:expand="scope">
          <div v-for="(item,index) in scope.scope.row.children" :key="item.authName" class="flex">
            <div class="from flex">
              <span class="mr40 flex a-c">
                <el-tag closable @close="handleClose(item,index,scope.scope.row)">
                  ...
                  <div class="flex mtb15 a-c">
                    <div class="mr40 flex a-c">
                      <el-tag
                        ...
                        size="small"
                        closable
                        @close="handleClose1(item,item1,index1,scope.scope.row)"
                      >
                    ...
                    <div class="one">
                      <el-tag
                        ...
                        size="small"
                        closable
                        @close="handleClose1(item1,item2,index2,scope.scope.row)"
...
export default {
  ...
  methods: {
    ...
    handleClose(item, index, scope) {
     ...
     //点击小标签的每一项（第二层）
    handleClose1(item, index1, item1, scope) {
      // console.log(item, "权限id");
      // console.log(scope, "角色id");
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        confirmButtonText: "确定",
     ...
     //点击小标签的每一项（第三层）
    handleClose2(item1, item2, index2, scope) {
      // console.log(item, "权限id");
      // console.log(scope, "角色id");
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        confirmButtonText: "确定",
