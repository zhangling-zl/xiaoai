...
export default {
  ...
  // },
   ...
   //编辑提交参数
   editCategories({id,attrId,attr_name,attr_sel,attr_vals}){
    return service.get(`categories/${id}/attributes/${attrId}?attr_name=${attr_name}&attr_sel=${attr_sel}&attr_vals=${attr_vals}`)
  },
