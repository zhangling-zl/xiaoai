<template>
  <div>
    ...
    <el-dialog title="编辑角色" :visible.sync="dialogFormVisibleAll" width="40%" :show-close="false" >
      <el-form :model="userslist" :rules="rulesAll" ref="userslist" label-width="100px" class="demo-ruleForm">
        <el-form-item label="用户名" prop="username" >
          <el-input v-model="userslist.username" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="email">
