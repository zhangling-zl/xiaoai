      ...
      <el-form :model="fromoptions" :rules="rules" ref="from">
        ...
        <!--  没有下拉和级联选择器的时候 -->
          <el-form-item
            ...
            :prop="item.prop"
            v-if="!item.children && !options && item.type==='iuput'"
          >
            <!-- 动态渲染组件 -->
            <component
              :is="`el-${item.type}`"
          ...
          <!-- 有下拉框的时候 -->
          <el-form-item
            v-if="item.children && !options && item.type==='select'"
            :key="index"
            :label="item.label"
            :label-width="item.labelWidth"
            :prop="item.prop"
          ...
          <!-- 有联级选择器的时候 -->
          <el-form-item
            v-if="!item.children && options && item.type==='cascader'"
            :key="index"
            :label="item.label"
            :label-width="item.labelWidth"
            :prop="item.prop"
