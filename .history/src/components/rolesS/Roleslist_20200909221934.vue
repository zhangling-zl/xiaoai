      ...
      >
        ...
        <template v-slot:expand="scope">
          <div>
            <el-tag
              :key="tag"
              v-for="tag in scope.scope.row.children"
              closable
              @close="handleClose(tag,scope.scope.row.children.authName)"
            >
              <div class="mr20">{{tag.authName}}</div>
             ...
             <!-- <el-tag
                ...
                @close="handleClose(tag1,tag.children)"
          ...
          <!--<el-tag
            class="tag"
            :key="tag"
            v-for="tag in scope.scope.row"
            closable
            :disable-transitions="false"
            @close="handleClose(tag,scope.scope.row.roleDesc)"
          >{{scope.scope.row.roleDesc}}</el-tag>-->
        </template>
      </ai-table>
    </el-card>
