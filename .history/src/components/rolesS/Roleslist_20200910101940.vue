...
export default {
  ...
  methods: {
    ...
    determine() {
      ...
      //通过 node 获取
      console.log(this.$refs.tree.getCheckedNodes(), "通过 node 获取");
      //通过 key 获取
      console.log(this.$refs.tree.getCheckedKeys(),'通过 key 获取');
      //通过 node 设置
     console.log( this.$refs.tree.setCheckedNodes(this.idd),'通过 node 设置');
      //通过 key 设置
     console.log( this.$refs.tree.setCheckedKeys(this.idd),'通过 key 设置');
      //清空
     console.log( this.$refs.tree.setCheckedKeys([]),'清空');
    },
  },
