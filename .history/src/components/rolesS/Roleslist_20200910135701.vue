          ...
          <div v-for="item in scope.scope.row.children" :key="item.authName" class="flex">
            <div class="from flex">
              <span class="mr40 flex a-c">
                <el-tag closable @close="handleClose(item,scope.scope.row.children,scope.scope.row)">
                ...
                <div v-for="item1 in item.children" :key="item1.authName">
                  <div class="flex mtb15 a-c">
                    <div class="mr40 flex a-c">
                      <el-tag type="success" size="small" closable @close="handleClose(item1,item.children,scope.scope.row)">
                    ...
                    <div class="one">
                      <el-tag
                        ...
                        size="small"
                        closable
                        @close="handleClose(item2,item1.children,scope.scope.row)"
...
export default {
  ...
  methods: {
    ...
    handleClose(scope,row) {
      console.log(scope.scope,'权限id');
      console.log(row,'角色id');
      // this.deleteRolesId({
