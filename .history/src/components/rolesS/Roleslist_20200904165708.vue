...
export default {
  ...
  methods: {
    ...
    edit(scope) {
      ...
      this.fromData.value = scope.row.roleName;

      this.Edit.id = scope.row.id,
      this.Edit.roleName = scope.row.roleName,
      this.Edit.roleDesc = scope.row.roleDesc,
