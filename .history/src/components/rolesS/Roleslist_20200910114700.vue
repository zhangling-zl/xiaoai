    ...
    <el-card class="box-card">
      ...
      >
        ...
        <template v-slot:expand="scope">
          <div v-for="item in scope.scope.row.children" :key="item.authName">
            <div class="from">
              <span class="mr40">
                <el-tag closable @close="handleClose(item,scope.scope.row.children)">
                  <span>{{item.authName}}</span>
                </el-tag>
                <i class="el-icon-caret-right"></i>
              </span>
              <span v-for="item1 in item.children" :key="item1.authName">
                <span class="mr40">
                  <el-tag type="success" closable @close="handleClose(item1,item.children)">
                ...
                <span class="one">
                  <el-tag
                    ...
                    type="warning"
                    closable
                    @close="handleClose(item2,item1.children)"
