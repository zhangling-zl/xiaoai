          ...
          <div v-for="item in scope.scope.row.children" :key="item.authName" class="flex">
            <div class="from flex">
              <span class="mr40 flex a-c">
                <el-tag closable @close="handleClose(scope.scope.row.children,scope.scope.row)">
                ...
                <div v-for="item1 in item.children" :key="item1.authName">
                  <div class="flex mtb15 a-c">
                    <div class="mr40 flex a-c">
                      <el-tag type="success" size="small" closable @close="handleClose(item.children,scope.scope.row)">
                    ...
                    <div class="one">
                      <el-tag
                        ...
                        size="small"
                        closable
                        @close="handleClose(item1.children,scope.scope.row)"
