      ...
      <el-card class="box-card">
        ...
        >
          <template v-slot:action="scope">
            <el-button size="mini" type="primary" @click="edit(scope.scope)"><i class="el-icon-edit"></i></el-button>
            <el-button size="mini" type="danger" @click="dli(scope.scope)"><i class="el-icon-delete"></i></el-button>
          </template>
        </ai-table>
      </el-card>
...
export default {
  ...
  methods: {
    ...
    dli(scope) {
      ...
      console.log(scope.row.goods_id, "删除");
