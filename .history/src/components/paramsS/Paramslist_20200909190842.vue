        ...
        <el-tab-pane label="动态参数" name="first">
          ...
          >
            ...
            <template v-slot:expand="scope">
              ...
              <el-input
                class="input-new-tag"
                v-if="scope.scope.row.inputVisible"
                v-model="inputValue"
                ref="saveTagInput"
                size="small"
                @keyup.enter.native="handleInputConfirm(scope.scope.row)"
                @blur="handleInputConfirm(scope.scope.row)"
              ></el-input>
              <el-button
                v-else
                class="button-new-tag"
                size="small"
                @click="showInput(scope.scope.row)"
              >+ New Tag</el-button>
            </template>
          </ai-table>
          <!--表单编辑-->
