    ...
    <el-card class="box-card">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="静态属性" name="second">
          <div><el-button type="primary" size="mini" v-if="categor.length" @click="addSS">添加属性</el-button>
          <el-button type="primary" size="mini" disabled v-else>添加属性</el-button></div>
          <!--表格 -->
          <ai-table
            :border="border"
            :Role="categor"
