    ...
    <el-card class="box-card">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="动态参数" name="first">
          <el-button type="primary" size="mini" v-if="categor.length" @click="add" class="mb20">添加参数</el-button>
          <el-button type="primary" size="mini" disabled v-else class="mb20">添加参数</el-button>
          <!--表格 -->
          <ai-table
            :border="border"
            :Role="categor"
        ...
        <el-tab-pane label="静态属性" name="second">
          <el-button type="primary" size="mini" v-if="categor.length" @click="addSS" class="mb20">添加属性</el-button>
          <el-button type="primary" size="mini" disabled v-else class="mb20">添加属性</el-button>
          <!--表格 -->
          <ai-table
            :border="border"
            :Role="categor"
