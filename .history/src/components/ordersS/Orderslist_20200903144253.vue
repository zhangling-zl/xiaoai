<template>
  <div>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-tooltip class="item" effect="dark" content="物流信息" placement="top">
              <el-button size="mini" type="success" @click="Logistics(scope.$index, scope.row)">
    ...
    <el-dialog title="物流信息" :visible.sync="dialogFormVisibleALl" width="40%" :show-close="true">
      <el-steps direction="kuaidi" :active="1">
...
export default {
  ...
  data() {
    return {
      ...
      consignee_addr: "", //发货地址
      //
      id: 804909574412544600, //物流单号
      dialogFormVisibleSLl: false, //控制编辑地址弹框的显示与隐藏
      dialogFormVisibleALl: false, //控制物流消息弹框的显示与隐藏
      citydata: [], //城市选择
      //
      list: [],
      list1: [],
