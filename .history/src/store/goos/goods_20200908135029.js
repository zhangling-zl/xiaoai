...
export default {
    ...
    actions: {
        ...
        //     }
        // }
        putCategories({dispatch},{id,attrId,attr_name,attr_sel,attr_vals,sel}){
            console.log(commit);
            let res = await api.putCategories({ id,attrId,attr_name,attr_sel,attr_vals,sel })
            if(res.meta.status === 200){
                dispatch('Categories',{id,attrId,attr_name,attr_sel,attr_vals,sel})
            }
