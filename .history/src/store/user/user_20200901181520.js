...
export default {
    ...
    actions: {
        ...
        //修改用户状态
        async putState({ dispatch }, { uId, type, pagenum, pagesize }) {
        ...
        //删除单个用户
        async deleteUsers({ dispatch }, { id, pagenum, pagesize }) {
        ...
        // },
        // //编辑用户信息
        // async putUsersid({ dispatch }, { id, email, mobile ,pagenum, pagesize}) {
